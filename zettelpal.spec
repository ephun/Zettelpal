...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'sklearn.cluster',
        'numpy',
        # Insights subpackage (imported lazily in the GUI/CLI)
        'zettelpal.insights',
        'zettelpal.insights.corpus',
        'zettelpal.insights.themes',
        'zettelpal.insights.rag',
        'zettelpal.insights.digest',
        'zettelpal.insights.resurfacing',
        'zettelpal.insights.writer',
        'requests',
        'typer',
        'pydantic',
        'pydantic_settings',
